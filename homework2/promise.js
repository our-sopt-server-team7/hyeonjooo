...
const func1 = (param)=>{
    return new Promise((resolved, rejected) =>{
        setTimeout(()=>{
            ...
            resolved('func 1 success:' + param + '/n');
        }, 500);
    });
}
...
const func2 = (param)=>{
    return new Promise((resolved, rejected)=>{
        setTimeout(()=>{
            ...
            rejected(new Error('func 2 error:' + param + '/n'));
        }, 500);
    });
}
...
const func3 = (param)=>{
    return new Promise((resolved, rejected) =>{
        setTimeout(()=>{
            ...
            resolved('func 3 success:' + param + '/n');
        }, 500);
    });
}
...
const func4 = (param)=>{
    return new Promise((resolved, rejected)=>{
        setTimeout(()=>{
            ...
            rejected(new Error('func 4 error:' + param + '/n'));
        }, 500);
    });
}
...
const func5 = (param)=>{
    return new Promise((resolved, rejected) =>{
        setTimeout(()=>{
            ...
            resolved('func 5 success:' + param + '/n');
        }, 500);
    });
}
